      ...
      <div className="w-full max-w-5xl">
        ...
        <section>
          ...
          <div className="prose max-w-none text-muted-foreground space-y-2 sm:space-y-3 md:space-y-4 text-justify text-xs sm:text-sm md:text-base">
            ...
            <p>
              More broadly, my research is interdisciplinary by design, integrating <strong>human-centered theories of learning</strong> and <strong>human intelligence</strong> to examine the fundamental processes underlying <strong>personalized learning, assessment, and feedback</strong> across diverse <strong>STEM</strong> and <strong>language learning contexts</strong> within <strong>higher education</strong> and <strong>lifelong learning</strong> environments. As a <strong>mixed-methods design-based researcher</strong>, I engage in iterative cycles of design, implementation, and empirical investigation to develop and refine responsible AI-augmented systems that address complex educational challenges and contribute to <strong>meaningful societal impact at scale</strong>.
            </p>
            <p>
            ...
            <p>
              Previously, I was a Graduate Research Associate in the <a href="https://www.ai2researchlab.org/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">AI2RL Lab</a> (2021-25), where I contributed to <strong>three federally funded National Science Foundation (NSF)</strong> projects. The first was the <a href="https://www.nsf.gov/awardsearch/show-award/?AWD_ID=2054968" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">SaTC Project</a>, supported by <strong>~$400,000</strong>, in which I worked with <a href="https://scholar.google.com/citations?user=8OTNELUAAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Daniel Takabi</a> on the design and deployment of a Private AI curriculum using problem-centered instruction, hands-on labs, and real-world scenarios to develop students' skills in building trustworthy AI systems. The second was the <a href="https://www.nsf.gov/awardsearch/show-award?AWD_ID=2247790" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">National AI Research Institutes Project</a>, supported by <strong>~$20 million</strong>, where, through <a href="https://aialoe.org/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">AI-ALOE</a>, I collaborated with leading scholars including <a href="https://scholar.google.com/citations?user=VjNg25EAAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Ashok Goel</a>, <a href="https://scholar.google.com/citations?user=dcTwIeQAAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Chris Dede</a>, and <a href="https://scholar.google.com/citations?user=PDzqXW4AAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Scott Crossley</a> on the human-centered design and deployment of AI technologies for personalized online adult learning, lifelong learning, and workforce development. The third was the <a href="https://www.nsf.gov/awardsearch/show-award?AWD_ID=2315709" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">IUSE Project</a>, supported by <strong>~$300,000</strong>, which aimed to design and deploy an AI-augmented formative assessment and feedback system to provide personalized learning support to enhance engagement, problem-solving, and self-regulated learning in large introductory physics courses.
            </p>
