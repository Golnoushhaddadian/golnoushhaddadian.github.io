      ...
      <div className="w-full max-w-5xl">
          ...
          <div className="md:w-2/3 text-center md:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-2 sm:gap-x-5 text-xs sm:text-sm">
              ...
              <a href="mailto:ghaddadian1@gsu.edu" className="flex items-center gap-1.5 text-foreground/70 hover:text-foreground transition-colors" aria-label="Email">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true"><path d="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67zM22.5 6.908V6.75a3 3 0 00-3-3h-15a3 3 0 00-3 3v.158l9.714 5.978a1.5 1.5 0 001.572 0L22.5 6.908z" /></svg>
        ...
        <section>
          ...
          <div className="prose max-w-none text-muted-foreground space-y-2 sm:space-y-3 md:space-y-4 text-xs sm:text-sm md:text-base">
            ...
            <p>
              Previously, I was a Graduate Research Associate in the <a href="https://www.ai2researchlab.org/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">AI2RL Lab</a> at Georgia State University (August 2021 to December 2025), under the supervision of <a href="https://scholar.google.com/citations?user=H0ROCdEAAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Dr. Min Kyu Kim</a>, where I contributed to three federally funded <strong>National Science Foundation (NSF)</strong> research projects. The first was the <a href="https://www.nsf.gov/awardsearch/show-award/?AWD_ID=2054968" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">SaTC Project</a>, supported by <strong>~$400,000</strong>, in which I worked with <a href="https://scholar.google.com/citations?user=8OTNELUAAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Dr. Daniel Takabi</a> on the design and deployment of a Private AI curriculum using problem-centered instruction, hands-on labs, and real-world scenarios to develop students' skills in building trustworthy AI systems. The second was the <a href="https://www.nsf.gov/awardsearch/show-award?AWD_ID=2247790" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">National AI Research Institutes Project</a>, supported by <strong>~$20 million</strong>, where, through <a href="https://aialoe.org/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">AI-ALOE</a>, I collaborated with scholars including <a href="https://scholar.google.com/citations?user=VjNg25EAAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Ashok Goel</a>, <a href="https://scholar.google.com/citations?user=dcTwIeQAAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Chris Dede</a>, and <a href="https://scholar.google.com/citations?user=PDzqXW4AAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Scott Crossley</a> on the human-centered design and deployment of AI technologies for personalized online adult learning, lifelong learning, and workforce development. The third was the <a href="https://www.nsf.gov/awardsearch/show-award?AWD_ID=2315709" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">IUSE Project</a>, supported by <strong>~$300,000</strong>, which aimed to design and deploy an AI-augmented formative assessment and feedback system using AI-scaffolded adaptive feedback and personalized learning support to enhance engagement, problem-solving, and self-regulated learning in large introductory physics courses.
            </p>
            <p>
