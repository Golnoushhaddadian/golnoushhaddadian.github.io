      ...
      <div className="w-full max-w-4xl">
        ...
        <section>
          ...
          <div className="prose max-w-none text-muted-foreground space-y-2 sm:space-y-3 md:space-y-4 text-xs sm:text-sm md:text-base">
            ...
            <p
              className="cursor-default italic font-medium text-muted-foreground transition-all duration-700 hover:text-primary hover:[text-shadow:0_0_8px_hsl(var(--primary)/0.4),0_0_20px_hsl(var(--primary)/0.2)]"
            >
