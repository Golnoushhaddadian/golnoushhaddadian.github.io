...
const AboutMe = () => {
  ...
  return <div className="min-h-screen flex flex-col items-center py-4 sm:py-6 md:py-8 px-2 sm:px-4 md:px-6">
      <div className="w-full max-w-5xl">
        <div className="flex flex-col md:flex-row items-center gap-4 sm:gap-6 md:gap-8 mb-4 sm:mb-5 md:mb-6">
          ...
          <div className="flex-1 min-w-0 text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start gap-y-2 text-xs sm:text-sm">
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-4 sm:gap-x-5">
                ...
                <a href="https://orcid.org/0000-0002-4239-9086" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-foreground/70 hover:text-foreground transition-colors" aria-label="ORCID">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true"><path d="M12 0C5.372 0 0 5.372 0 12s5.372 12 12 12 12-5.372 12-12S18.628 0 12 0zM7.369 4.378c.525 0 .947.431.947.947 0 .525-.422.947-.947.947-.525 0-.946-.422-.946-.947 0-.516.421-.947.946-.947zm-.722 3.038h1.444v10.041H6.647V7.416zm3.562 0h3.9c3.712 0 5.344 2.653 5.344 5.025 0 2.578-2.016 5.025-5.325 5.025h-3.919V7.416zm1.444 1.303v7.444h2.297c3.272 0 4.022-2.484 4.022-3.722 0-2.016-1.284-3.722-4.097-3.722h-2.222z" /></svg>
                  <span>ORCID</span>
                </a>
              </div>
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-4 sm:gap-x-5">
                ...
                <a href="https://gsu.academia.edu/GHaddadian" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-foreground/70 hover:text-foreground transition-colors" aria-label="Academia">
        ...
        <section>
          ...
          <div className="prose max-w-none text-muted-foreground space-y-2 sm:space-y-3 md:space-y-4 text-justify text-xs sm:text-sm md:text-base">
            ...
            <p>
              <strong>At the heart of my work is a simple belief:</strong> AI should not replace humans, but at its best should serve as connective tissue that amplifies human potential, strengthens agency, deepens thinking and reasoning, and enables learners and educators to connect, create, and achieve what would not be possible alone. Human progress has never occurred in isolation; it emerges through our ability to understand one another, cultivate trust, build meaningful relationships, and collaborate toward mutual goals. As AI continues to advance in its ability to reason, generate solutions, and operate with increasing autonomy, its greatest promise lies in reinforcing such unique and fundamental human qualities and expanding the possibilities we can achieve together. If you ask me about the future of the workforce, I would say: AI will disrupt work and displace some tasks, yet it need not take human jobs. When designed to complete than compete, AI augments people instead of replacing them. That is the future of work: <strong>not artificial intelligence</strong>, <strong>but hybrid intelligence</strong>. The decisive variable for success is therefore our readiness and our capacity to embrace it.
            </p>
            </>)}
            {/* PARKED-HOMEPAGE: Four research pillars — temporarily hidden. Flip false→true to restore. */}
            {false && (
