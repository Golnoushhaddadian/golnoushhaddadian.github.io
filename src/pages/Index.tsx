  ...
  const researchInterests = [
    {
      ...
      text: "Instructional/Educational Technology, AI in Education, AI-Augmented Learning Environments, Adaptive Learning Technologies, Personalized Learning Environments; Human-Computer Interaction"
    },
    {
      icon: <FileText className="h-5 w-5 text-primary" />,
      text: "Formative Assessment and Feedback, Peer Feedback, Collaborative Learning"
    },
    {
      icon: <Layers className="h-5 w-5 text-primary" />,
      text: "Automated Writing Evaluation (AWE) Systems, Essay Writing, Computer Assisted Language Learning (CALL)"
    },
    {
      icon: <FileCode className="h-5 w-5 text-primary" />,
      text: "Curriculum Design and Development; Design Based Research (DBR); Mixed-Methods Research"
    }
  ];
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
          <div className="md:w-1/3 flex justify-center">
            <Avatar className="h-64 w-64 rounded-lg">
              <AvatarImage src="/your-profile-image.jpg" alt="Golnoush (Lia) Haddadian" />
